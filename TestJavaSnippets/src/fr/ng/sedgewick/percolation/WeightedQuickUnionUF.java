 ...
 ****************************************************************************/
/**
 * The <tt>WeightedQuickUnionUF</tt> class represents a union-find data structure. It supports the
 * <em>union</em> and <em>find</em> operations, along with methods for determinig whether two
 * objects are in the same component and the total number of components.
 * <p>
 * This implementation uses weighted quick union by size (without path compression). Initializing a
 * data structure with <em>N</em> objects takes linear time. Afterwards, <em>union</em>,
 * <em>find</em>, and <em>connected</em> take logarithmic time (in the worst case) and
