...
public class TableComboViewerSnippet1 {
    ...
    private static class SingleItemLabelProvider extends LabelProvider implements
            ITableLabelProvider {
        /**
    ...
    private static class SingleImageItemLabelProvider extends LabelProvider implements
            ITableLabelProvider {
        /**
         * We return null, because we don't support images yet.
         * 
    ...
    private static class ThreeLabelProvider extends LabelProvider implements ITableLabelProvider,
    ...
    private static class MultipleColorLabelProvider extends LabelProvider implements
