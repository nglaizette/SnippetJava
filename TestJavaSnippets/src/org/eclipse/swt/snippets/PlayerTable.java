...
class PlayerLabelProvider implements ITableLabelProvider, ITableColorProvider {
    // Image to display if the player led his team
    private Image ball;

    // Constructs a PlayerLabelProvider
    public PlayerLabelProvider() {
        // ball = new Image(null, new FileInputStream("invalid_build_tool_16x16.gif"));
        ball = ImageDescriptor.createFromFile(PlayerLabelProvider.class,
